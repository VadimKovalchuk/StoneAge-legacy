...
def main():
    ...
    constants['LAND_TILES_DIR']     = str('pics\\tiles\\')
    constants['SPRITES_DIR']        = str('pics\\sprite\\')
    constants['SCENARIO_DIR']       = str('scenario\\')
    constants['CONTROLS_DIR']       = str('pics\\')
    constants['MARKERS_DIR']        = str('pics\\markers\\')
    constants['ICONS_DIR']          = str('pics\\icons\\')
    constants['BACKGROUNDS_DIR']    = str('pics\\backgrounds\\')
    constants['POPUPS_DIR']         = str('pics\\popups\\')
